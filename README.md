# Diverse360 - Production Deployment Guide

A platform for Diversitech students and alumni, offering learning, jobs, and community.
...
3. **Create New Web Service**
   ...
   - Select your `diverse-360` repository

4. **Configure the service:**
   - **Name**: `diverse-360-backend`
...
|-----|-------|-------|
| `NODE_ENV` | `production` | |
| `CORS_ORIGIN` | `https://diverse-360.netlify.app` | Update after frontend deployment |
...
3. **Test your backend**: Visit `https://diverse-360-backend.onrender.com/api/health`
...
3. **Configure the project:**
   - **Project Name**: `diverse-360-frontend`
...
|-----|-------|-------------|
| `REACT_APP_API_URL` | `https://diverse-360-backend.onrender.com/api` | Production |
...
2. **Update Environment Variables**:
   - Set `CORS_ORIGIN` to your actual Netlify URL: `https://diverse-360.netlify.app`
...
### 1. Health Check
Visit: `https://diverse-360-backend.onrender.com/api/health`
...
Visit: `https://diverse-360.netlify.app`
